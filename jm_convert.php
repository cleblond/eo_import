...
if (($handle = fopen("muzyka.csv", "r")) !== FALSE) {
    ...
    <questiontext format="html">
      <text><![CDATA[<p>Provide the major product for the following reaction?</p><p><br></p><p><img alt="Embedded Image" src="'.$base64.'" /><br></p>]]></text>
    </questiontext>
...
$file = 'jm_predict_products_moodle.xml';
...
$url = "http://cactus.nci.nih.gov/chemical/structure/".$smiles."/iupac_name";
//$url="http://cactus.nci.nih.gov/chemical/structure/C1%3DCC%3DCC%3DC1/iupac_name";
//echo $url;

$str = file_get_contents($url);

if($str==false){echo "The Chemical Identifier Resolver at http://cactus.nci.nih.gov must be down or is having problems, please try again later.";

}else{
echo "<h2>Draw ".$str." in the window below:</h2><br>";
